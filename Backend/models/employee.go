...
type Employee struct {
	...
	EmpShift   string         `gorm:"type:varchar(50);not null" json:"emp_shift"` // e.g., Morning, Evening
	HireDate   time.Time      `gorm:"type:date;not null" json:"hire_date"`
	JobTitle   string         `gorm:"type:varchar(100);not null" json:"job_title"` // e.g., Cashier, Manager
